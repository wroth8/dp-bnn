function [errs, y] = dpnnEvaluateEnsembleForward( models, x, t, varargin )
% This function is basically the same as dpnnEvaluateEnsemble with the only
% difference that the cumulative sample averages are computed in the order
% as they are given in models. This is more natural than the reverse order,
% but it does not allow easily to verify the influence of burn-in which is
% more easily done via dpnnEvaluateEnsemble. Some more details can be found
% in the documentation of dpnnEvaluateEnsembleForward.
%
% Input:
...
%   essentially the difference to dpnnEvaluateEnsemble.
